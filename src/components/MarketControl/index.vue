  ...
  <div class="visitor-control">
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="box-card">
          ...
          <div class="visitor-control-search">
            <el-input class="visitor-control-search-input" v-model="search.title" clearable placeholder="请输入商品名称"></el-input>
          ...
          <div class="visitor-control-table">
            <el-table
              ...
              <el-table-column prop="goods_title" label="商品名称" width="120">
              </el-table-column>
              <el-table-column prop="goods_type" label="商品类型" width="120">
              </el-table-column>
              <el-table-column prop="goods_desc" label="商品描述">
              </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :model="addForm" label-width="80px">
        ...
        <el-form-item label="是否已经下架">
          <!-- <el-input v-model="addForm.done"></el-input> -->
          <el-select class="visitor-control-search-input" v-model="addForm.done" clearable placeholder="请选择是否已经下架">
            <el-option
              v-for="item in optionsGoodsOff"
              :key="item.value"
              :label="item.label"
    ...
    <el-dialog
      ...
      <el-form ref="form" :model="editForm" label-width="120px">
        ...
        <el-form-item label="是否已经下架">
          ...
          <el-select class="visitor-control-search-input" v-model="editForm.done" clearable placeholder="请选择是否已经下架">
            <el-option
              v-for="item in optionsGoodsOff"
              :key="item.value"
              :label="item.label"
...
export default {
  ...
  methods: {
    ...
    async delNoticeById (id) {
      const confirmResult = await this.$confirm('是否删除商品信息', '提示', {
