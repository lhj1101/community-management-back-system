      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="box-card">
          ...
          <div class="report-repair-control-search">
            <el-input class="report-repair-control-search-input" v-model="searchRepair" clearable placeholder="请输入损坏物品"></el-input>
            <el-select class="report-repair-control-search-input" v-model="searchExtent" clearable placeholder="请选择损坏程度">
              <el-option
            ...
            <el-select class="report-repair-control-search-input" v-model="searchDone" clearable placeholder="请选择是否已经完成">
              <el-option
